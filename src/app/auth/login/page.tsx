...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 selection:bg-primary selection:text-primary-foreground relative overflow-hidden">
            ...
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-500/20 blur-[128px] rounded-full pointer-events-none" />
                        ...
                        <form className="flex flex-col gap-6" action={formAction}>
                            ...
                            <div className="space-y-1.5 mb-2">
                                <div className="flex items-center justify-between ml-1">
                                    ...
                                    <Link
                                        href="#"
                                        className="text-sm font-medium text-primary hover:text-primary/80 hover:underline transition-colors block"
                                    >
                                        Forgot password?
                                    </Link>
                                </div>
                            ...
                            <div className="text-center text-sm text-muted-foreground mt-4 font-medium">
                                ...
                                <Link href="/auth/signup" className="text-primary font-bold hover:underline transition-colors drop-shadow-sm">
                                    Sign up instead
                                </Link>
                            </div>
                        </form>
